...
if (isset($_POST['create'])) {
  ...
  $email = $_POST['email'];
  $pass = $_POST['pass'];
  $result = $conn->query("INSERT INTO users (Name, Email, Phone, Password)  VALUES ('$name','$email','$phone','$pass')");
  echo "<script type='text/javascript'>
                Swal.fire('Success!', 'Account registered successfully!', 'success').then(function() {
            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form action="" method="POST">
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="form2Example11" class="form-control"
                      placeholder="Ex. Juan Dela Cruz" required name="name" />
                    <label class="form-label" for="form2Example11">Full Name</label>
                  </div>

                  <div class="form-outline mb-4">
                    <input type="password" id="form2Example22" class="form-control" required name="pass" />
                    <label class="form-label" for="form2Example22">Password</label>
                  </div>

                  <div class="text-center pt-1 mb-5 pb-1">
                    <button name="create" class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit" >Create</button>
